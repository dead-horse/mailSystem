...
function IncomingForm() {
  ...
  this.limit = 100; // limit fields count, default is 100;
  this.keys = null; // allow field names, default is allow any keys
...
IncomingForm.prototype.onPart = function(part) {
  ...
  console.log(this._fieldsCount, part)
  // check allow keys
  if (this.keys && !this.keys[part.name]) {
    return;
  }
  // this method can be overwritten by the user
  this.handlePart(part);
...
IncomingForm.prototype.checkLimit = function() {
  this._fieldsCount++;
  if (this.limit && this._fieldsCount > this.limit) {
    this._error(new Error('limit ' + this.limit + ' fields exceeded'));
    return false;
  }
  return true;
};
